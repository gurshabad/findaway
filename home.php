...
<div class="row" style="text-align: center;">
		<p></p>
		<p class="roller">Find A Way is about helping you help others. We are on a mission to change the world. <span class="text-muted">On our own terms.</span></p>
		...
		<p> <object><param name="movie" value="http://www.youtube.com/v/3NtaOs-sxi0?hl=en_US&;version=3&rel=0&autohide=1&showinfo=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/3NtaOs-sxi0?hl=en_US&;version=3&autoplay=1&rel=0&autohide=1&showinfo=0" type="application/x-shockwave-flash" width="70%" height="400" allowscriptaccess="always" allowfullscreen="true"></embed></object></p>
</div>
<div class="row">
